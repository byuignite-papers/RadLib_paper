...
if __name__=='__main__':
    import sys
    method = sys.argv[1] if len(sys.argv)>1 else 'rcslw' # rcslw, wsgg, planckmean
    nGG = int(sys.argv[2]) if len(sys.argv)>2 else 24
    xQ, Q = ex_S3(method, nGG)
