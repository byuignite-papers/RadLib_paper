...
int main() {
    ...
    rad *rc24 = new rad_rcslw(24, P, Tavg, xH2O_avg, xco2, xco, fvs);    
    ...
    clock_t c1, c2;
    double d1, d2;
    double pm_time, ws_time, rc_time, rc1_time, rc8_time, rc24_time;
    double ave = 0;
    double q_arb = 0;
    ...
    c1 = clock();
    for(int i=0; i<n_sim; i++) {
	    parallel_planes(rc24, L, ntheta, P, T, xH2O, xCO2, xCO, xCH4, fvsoot, q, Q, x, xQ);
	    q_arb += q[0];
    }
    c2 = clock();
    d1 = c1;
    ...
    ave = (d2-d1)/CLOCKS_PER_SEC / n_sim;
    rc24_time = ave;
    cout << endl << "RC 24 time " << rc24_time;
