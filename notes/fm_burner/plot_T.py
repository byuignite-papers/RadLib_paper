...
git = np.loadtxt('fds_test_line_T.csv', delimiter=',')
wsgg = np.loadtxt('fds_wsgg_line_T.csv', delimiter=',')
rcslw = np.loadtxt('fds_rcslw_line_T.csv', delimiter=',')
exp_m_1p5D = np.loadtxt('exp/T_mean_1p5D_exp.csv', delimiter=',')
exp_m_2p5D = np.loadtxt('exp/T_mean_2p5D_exp.csv', delimiter=',')
exp_m_3p5D = np.loadtxt('exp/T_mean_3p5D_exp.csv', delimiter=',')
