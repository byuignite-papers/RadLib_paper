...
git   = np.loadtxt('default_fds_line_rad.csv', delimiter=',')
wsgg  = np.loadtxt('wsgg_fds_line_rad.csv',    delimiter=',')
rcslw = np.loadtxt('rcslw_fds_line_rad.csv',   delimiter=',')
exp_m = np.loadtxt('rad_mean_exp.csv', delimiter=',')
exp_r = np.loadtxt('rad_rms_exp.csv',  delimiter=',')
