...
git = np.loadtxt('default_line_T.csv', delimiter=',')
wsgg = np.loadtxt('wsgg_line_T.csv', delimiter=',')
rcslw = np.loadtxt('rcslw_line_T.csv', delimiter=',')
exp_m_1p5D = np.loadtxt('T_mean_1p5D_exp.csv', delimiter=',')
exp_m_2p5D = np.loadtxt('T_mean_2p5D_exp.csv', delimiter=',')
exp_m_3p5D = np.loadtxt('T_mean_3p5D_exp.csv', delimiter=',')
...
plt.text(0.5, 1220, "z=2.5D", color='blue')
